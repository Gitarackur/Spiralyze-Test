      ...
      >
        ...
        <div class="md:hidden">
          ...
          >
            ...
            />
            <path
              d="M0 5H19C19.5523 5 20 5.44772 20 6C20 6.55228 19.5523 7 19 7H0V5Z"
              fill="white"
            />
            <path
              d="M0 10H19C19.5523 10 20 10.4477 20 11C20 11.5523 19.5523 12 19 12H0V10Z"
              fill="white"
            />
          </svg>
        </div>
...
export default {
  ...
  components: { TaskInput, TaskSelect },
  data() {
    return {
      form: {
        firstName: null,
